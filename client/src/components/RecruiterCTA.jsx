...
const RecruiterCTA = () => {
  ...
  return (
    <div className="container mx-auto px-4 2xl:px-20 py-16">
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12 bg-gray-200 rounded-3xl p-8 lg:p-12 shadow-sm border border-gray-100 overflow-hidden relative">
