...
const Portal = () => {
  ...
  return (
    <div className='bg-gradient-to-r from-[#435e2e] to-[#dbe1a6] text-white py-8 text-center px-4 md:px-8 mx-2 rounded-xl'>
      {/* Heading */}
              ...
              >
                ...
                <div style={{ padding: '20px 22px' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 'auto' }}>
                    ...
                    <button 
                      onClick={() => navigate('/news')}
                      style={{ color: '#6b7a2f', fontSize: 13, fontWeight: 700, background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}
