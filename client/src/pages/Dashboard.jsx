        ...
        <div className='min-h-screen'>
            ...
            <div className='shadow py-4'>
                <div className='px-5 flex justify-between items-center'>
                    <img onClick={e => navigate('/')} className=' max-sm:w-32 cursor-pointer' src={assets.logo} alt="" style={{ width: '150px', height: 'auto' }} />
                    {companyData && (
            ...
            <div className='flex items-start'>
                ...
                {/* left SideBar with options to add-jb, manage-job, view-applications */}
